...
class CVConnector(object):
    ...
    def get_image(self):
        ...
        "python_client", self.camera_id, 2,11,5)
    ...
    def get_ball(self, get_image = True,scale_factor=1,
                 haar_params=(1.3,5),
                 save_image=False, save_dir='DETECTED_BALL.jpg'):
        '''
        ...
        try:
            image1 = cv2.resize(self.last_image, 
                    (self.last_image.shape[0]//self.scale_factor,
                     self.last_image.shape[1]//self.scale_factor))
        ...
        if len(balls)==0:
            ...
            return None
        return balls
    def get_ball_center(self,get_image = True,scale_factor=1,
                 haar_params=(1.3,5),
                 save_image=False, save_dir='DETECTED_BALL.jpg'):#We predict only ball center coordinates
        balls = self._get_ball(get_image,scale_factor,haar_params,
                save_image,save_dir)
